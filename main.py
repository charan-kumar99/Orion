...
def speak(text):
    ...
    print(f"🤖 Orion: {text}")  # Robot emoji with Orion
    tts = gTTS(text)
    tts.save("temp.mp3")
...
if __name__ == "__main__":
    ...
    startup_message = f"{greeting}! I am Orion, your voice assistant. Say 'Orion' to wake me up."
    speak(startup_message)  # Only call speak to avoid duplication
        ...
        try:
            with sr.Microphone() as source:
                ...
                try:
                    ...
                    print(f"🧑 You said: {word}")  # Human emoji only
