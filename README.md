...
```bash
git clone https://github.com/charan-kumar99/Orion.git
cd Orion
```
...
1. **Start Orion**: Run `python main.py` or open the web interface.
2. **Give commands**: Type or speak your command — no wake word is required.
